<form action="{{ route('stores.orders.update', [$order->store->slug, $order->slug]) }}" method="post">
	{{ csrf_field() }}
	{{ method_field('patch') }}
	...
	<div class="card-block">
		<button type="submit" class="btn btn-warning btn-block">Izmeni narudžbinu</button>
	</div>
</form>